...
// Helper function for admin header
...
// Helper function for admin footer
...
void handleAdmin() {
  ...
  if (submenu == "") {
    ...
    html += "<a href='/admin_all?submenu=system' style='text-decoration: none; color: inherit;'>";
    html += "<div class='menu-card'>";
    html += "<h3>System</h3>";
    html += "<p>System & modem information, control functions</p>";
    html += "</div></a>";
    
    html += "<a href='/admin_all?submenu=settings' style='text-decoration: none; color: inherit;'>";
    html += "<div class='menu-card'>";
    html += "<h3>Settings</h3>";
    html += "<p>Hostname, debug, OLED, timezone configuration</p>";
    html += "</div></a>";
    
    html += "<a href='/admin_all?submenu=security' style='text-decoration: none; color: inherit;'>";
    html += "<div class='menu-card'>";
    html += "<h3>Security</h3>";
    html += "<p>Web username and password management</p>";
    html += "</div></a>";
    
    html += "<a href='/admin_all?submenu=network' style='text-decoration: none; color: inherit;'>";
    html += "<div class='menu-card'>";
    html += "<h3>Network</h3>";
    html += "<p>MQTT configuration and settings</p>";
    html += "</div></a>";
    
    html += "<a href='/admin_all?submenu=maintenance' style='text-decoration: none; color: inherit;'>";
    html += "<div class='menu-card'>";
    ...
    html += "<a href='/admin_all' class='btn btn-primary'>Back to Admin Menu</a>";
    html += "</div>";
