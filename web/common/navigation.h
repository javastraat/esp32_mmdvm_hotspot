...
String getNavigation(String activePage) {
  ...
  nav += "<button class='dropbtn' onclick='toggleDropdown(event)'" + String(activePage == "system" ? " style='background-color:var(--active-bg,#04AA6D);'" : "") + ">System &#9662;</button>";
  ...
  nav += "<a href='/status'" + String(activePage == "status" ? " class='active'" : "") + ">Status</a>";
  nav += "<a href='/systeminfo'" + String(activePage == "systeminfo" ? " class='active'" : "") + ">Info</a>";
  nav += "<a href='/systemsettings'" + String(activePage == "systemsettings" ? " class='active'" : "") + ">Settings</a>";
