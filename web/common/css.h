...
String getCommonCSS() {
  ...
  css += "  .topnav.responsive .dropdown {float: none;}";
  css += "  .topnav.responsive .dropdown-content {position: relative;}";
  css += "  .topnav.responsive .dropdown .dropbtn {display: block; width: 100%; text-align: left;}";
  css += "}";
