...
void handleSaveModes() {
  ...
  html += ".card { text-align: center; }";
  html += "h1 { color: #28a745; margin-bottom: 20px; }";
  html += ".info { margin: 20px 0; padding: 15px; background: var(--info-bg); border-left: 4px solid #007bff; text-align: left; border-radius: 4px; }";
  html += ".mode-status { padding: 10px; margin: 10px 0; background: var(--container-bg); border-radius: 4px; border: 1px solid var(--border-color); }";
  html += "a { color: #007bff; text-decoration: none; }";
  html += "a:hover { text-decoration: underline; }";
  html += "</style></head><body>";
  html += "<div class='container'>";
  ...
  html += "<div class='mode-status'>D-Star: <span style='color: var(--text-muted);'>Coming Soon</span></div>";
  html += "<div class='mode-status'>YSF: <span style='color: var(--text-muted);'>Coming Soon</span></div>";
