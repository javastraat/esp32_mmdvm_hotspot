...
String getPageHTML() {
  ...
  html += "function scanEspNow(){"
    ...
    "var tags='';"
    "if(f.dmr_relay)tags+='<span class=\"status-badge badge-success\" style=\"font-size:.78em\">DMR</span> ';"
    "if(f.pocsag_relay)tags+='<span class=\"status-badge badge-success\" style=\"font-size:.78em\">POCSAG</span> ';"
